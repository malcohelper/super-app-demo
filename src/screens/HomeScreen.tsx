...
const MINI_APPS = [
  {
    id: "ChatApp",
    name: "💬 Chat App",
    description: "Local chat with shared authentication",
    icon: "💬",
    color: "#6366f1",
  },
  {
...
export const HomeScreen: React.FC<Props> = ({ navigation }) => {
  const { userInfo, logout, deleteAccount } = useAuth();
    ...
    <View style={styles.container}>
      ...
      >
            ...
            <View style={styles.roleContainer}>
              ...
              >
                <Text style={styles.roleText}>
                  {userInfo?.role?.toUpperCase() || "GUEST"}
                </Text>
              </View>
            </View>
            {/* Permissions Tags */}
        ...
        <Text style={styles.sectionTitle}>
          Available Mini Apps ({availableMiniApps.length})
        </Text>
        ...
        <View style={styles.infoCard}>
          ...
          <Text style={styles.infoText}>
            This is a React Native Super App host using Module Federation. Mini
            Apps are loaded dynamically from remote CDN endpoints.
          </Text>
        </View>
      </ScrollView>
    </View>
